    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == OVERLAY_PERMISSION_REQUEST_CODE) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && Settings.canDrawOverlays(this)) {
                ...
                Toast.makeText(this, "需要悬浮窗权限才能保持应用在后台运行", Toast.LENGTH_LONG).show();
            }
        }
...
//      Cursor cursor = this.context.managedQuery(selectedVideoUri, filePathColumn, null, null, null);
    ...
    protected void onResume() {
        super.onResume();
        Log.d("MainActivity", "onResume: 应用回到前台");
        // 应用回到前台，恢复 WebView 状态
        if (webView != null) {
            webView.onResume();
    ...
    protected void onStop() {
        super.onStop();
        Log.d("MainActivity", "onStop: 应用进入后台");
        
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && Settings.canDrawOverlays(this)) {
            String currentUrl = webView.getUrl();
            Log.d("MainActivity", "当前URL: " + currentUrl);
            ...
            try {
                ...
                Log.e("MainActivity", "悬浮窗服务启动失败", e);
            }
        }
